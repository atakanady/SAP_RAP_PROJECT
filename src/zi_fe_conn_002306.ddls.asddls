...
define view entity zi_fe_conn_002306
  as select from zfe_aconn_002306 as Connection
  association [1..1] to zi_fe_carr_002306 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
